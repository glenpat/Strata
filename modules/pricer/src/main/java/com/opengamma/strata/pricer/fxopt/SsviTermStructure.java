...
/**
 * <PF>based off SmileDeltaTermStructure</PF>
 ...
 */
public interface SsviTermStructure
  ...
  public default DoubleArray getDeltaFull() {
    final int nbDelta = getDelta().size();
  ...
  //-------------------------------------------------------------------------
  @Override
  public abstract SsviTermStructure withParameter(int parameterIndex, double newValue);

  @Override
  public abstract SsviTermStructure withPerturbation(ParameterPerturbation perturbation);
