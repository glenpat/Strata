...
public class FxSingleBarrierOptionTradeCalculationFunctionTest {
  ...
  private static final FxVanillaOption VANILLA = FxVanillaOption.builder()
      .longShort(SHORT)
      ...
      .build();
  private static final FxSingleBarrierOption OPTION_PRODUCT = FxSingleBarrierOption.builder()
      .underlyingOption(VANILLA)
      .barrier(SimpleConstantContinuousBarrier.of(BarrierType.DOWN, KnockType.KNOCK_IN, 1.5))
      .build();
  ...
  public static final FxSingleBarrierOptionTrade TRADE = FxSingleBarrierOptionTrade.builder()
      .premium(PREMIUM)
      .product(OPTION_PRODUCT)
      .info(TRADE_INFO)
      .build();
  public static final ResolvedFxSingleBarrierOptionTrade RTRADE = TRADE.resolve(REF_DATA);
