...
public final class FxDigitalOption
  ...
  FxDigitalOption(
      ...
      final LocalTime expiryTime,
      final ZoneId expiryZone,
      final FxIndex index) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      final FxDigitalOption other = (FxDigitalOption) obj;
  ...
  public String toString() {
    ...
    buf.append("index").append('=').append(JodaBeanUtils.toString(this.index));
    buf.append('}');
    return buf.toString();
  }
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<FxDigitalOption> {
     ...
     */
    private Builder(final FxDigitalOption beanToCopy) {
     ...
     */
    public Builder barrierType(final BarrierType barrierType) {
      JodaBeanUtils.notNull(barrierType, "barrierType");
      this.barrierType = barrierType;
      return this;
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder expiryDate(final LocalDate expiryDate) {
      JodaBeanUtils.notNull(expiryDate, "expiryDate");
      this.expiryDate = expiryDate;
      return this;
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder expiryTime(final LocalTime expiryTime) {
      JodaBeanUtils.notNull(expiryTime, "expiryTime");
      this.expiryTime = expiryTime;
      return this;
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder expiryZone(final ZoneId expiryZone) {
      JodaBeanUtils.notNull(expiryZone, "expiryZone");
      this.expiryZone = expiryZone;
      return this;
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder index(final FxIndex index) {
      JodaBeanUtils.notNull(index, "index");
      this.index = index;
      return this;
    }
