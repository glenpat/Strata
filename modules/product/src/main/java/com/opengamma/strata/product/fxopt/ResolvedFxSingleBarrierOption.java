...
public final class ResolvedFxSingleBarrierOption
  ...
  private void validate() {
    if (this.rebate != null) {
      ArgChecker.isTrue(this.rebate.getAmount() > 0d, "rebate must be positive");
      ArgChecker.isTrue(this.underlyingOption.getUnderlying().getCurrencyPair().contains(this.rebate.getCurrency()),
   ...
   */
  @Override public CurrencyPair getCurrencyPair() {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(this.underlyingOption, other.underlyingOption) &&
          JodaBeanUtils.equal(this.barrier, other.barrier) &&
          JodaBeanUtils.equal(this.rebate, other.rebate);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(this.underlyingOption);
    hash = hash * 31 + JodaBeanUtils.hashCode(this.barrier);
    hash = hash * 31 + JodaBeanUtils.hashCode(this.rebate);
    return hash;
  }
  ...
  public String toString() {
    ...
    buf.append("underlyingOption").append('=').append(JodaBeanUtils.toString(this.underlyingOption)).append(',')
        .append(' ');
    buf.append("barrier").append('=').append(JodaBeanUtils.toString(this.barrier)).append(',').append(' ');
    buf.append("rebate").append('=').append(JodaBeanUtils.toString(this.rebate));
    buf.append('}');
    return buf.toString();
  }
