...
public final class FxSingleBarrierOption
    implements FxOption, Resolvable<ResolvedFxSingleBarrierOption>, ImmutableBean, Serializable {
  ...
  public ResolvedFxSingleBarrierOption resolve(ReferenceData refData) {
    if (this.rebate != null) {
      return ResolvedFxSingleBarrierOption.of(this.underlyingOption.resolve(refData), this.barrier, this.rebate);
    }
    return ResolvedFxSingleBarrierOption.of(this.underlyingOption.resolve(refData), this.barrier);
  }
